...
<form method="post">
  <center><h3>Activity Log</h3></center>
    <table class="content-table" style="border-collapse: collapse; margin: 25px 0; font-size: 0.8em; min-width: 400px;">
      <tr>
  ...
  font-weight: bold;">Date & Time</th>
    ...
    <?php
        ...
        error_reporting(0);
            ...
            echo "cannot find the data!";
          }
?>
  
   </table>
   <label name="uname" value="<?php echo @$email; ?>"></label>
   <center><button type="submit" class="btn" name="exit">Logout</button></center>
   <?php
       if(isset($_POST['exit'])) {
